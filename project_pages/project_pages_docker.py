...
project_pages_version = "2023_04_09"
...
class ProjectPages_Docker(DockWidget):
        ...
        if self.project_active == False:
            ...
            if exists == False:
                ...
                if valid == True:
                    ...
                    string = "Project Pages : Invalid File Error\n\nSolve version conflicts by importing multiple files into a new project\n"
    ...
    def Canvas_Conflict(self):
        string = "Project Pages : Active Pages Error\n\nClose all active document Pages to run\n"
        QMessageBox.information(QWidget(), i18n("Warnning"), i18n(string))
    def File_Conflict(self, path):
        string = "Project Pages : Namespace Conflict Error\n\nFolder with same name already exists\n"
        QMessageBox.information(QWidget(), i18n("Warnning"), i18n(string))
        ...
        if (self.canvas() is not None) and (self.canvas().view() is not None):
            ...
            if (node_name != "" and node_name != "SUCCESS"):
                ...
                if node_i != None: # Avoids instant Krita Crash
                    ...
                    string = "Project Pages : Layer Namespace Conflict Solved\n"
                    QMessageBox.information(QWidget(), i18n("Warnning"), i18n(string))
                    self.Layer_Rename()
