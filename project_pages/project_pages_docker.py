...
class ProjectPages_Docker(DockWidget):
    ...
    def Connections(self):
        ...
        self.layout.project.installEventFilter(self)
        self.layout.page.installEventFilter(self)
    def Modules(self):
        #region Notifier
    ...
    def Menu_Project(self, event):
        ...
        recent = len( self.recent_project )
    ...
    def eventFilter(self, source, event):
        ...
        # Project
        if (event.type() == QEvent.MouseButtonPress and source is self.layout.project):
            self.Menu_Project(event)
            return True
        # Page
        if (event.type() == QEvent.MouseButtonPress and source is self.layout.page):
