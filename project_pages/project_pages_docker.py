...
class ProjectPages_Docker(DockWidget):
    ...
    def Menu_ProjectContext(self, event):
        ...
        if (project_active == False and selected_len > 0):
    ...
    def ZIP_New(self, path, name):
        if self.project_active == False:
            ...
            if exists == False:
                ...
                self.layout.active_project.setText(project_displayname)
        ...
        if self.project_active == True:
            ...
            for i in range(1, limit):
                ...
                if check_name not in taken_names:
                    ...
                    # Guide
                    Krita.instance().activeDocument().setHorizontalGuides(self.doc_gh)
                    Krita.instance().activeDocument().setVerticalGuides(self.doc_gv)
    ...
    def Control_Load(self):
        if self.project_active == True:
            # Read File
            control = open(self.project_control, "r")
            ...
            if plugin == "project_pages":
                ...
                for i in range(0, len(data)):
                    ...
                    if item[0] == "doc_gh":
                        ...
                        self.dialog.doc_gh.setText( str(self.doc_gh)[1:-1] ) # Variable is list Text is not

                    if item[0] == "doc_gv":
                        self.doc_gv = eval( item[1] )
                        self.dialog.doc_gv.setText( str(self.doc_gv)[1:-1] ) # Variable is list Text is not
